...
Parse.Cloud.afterSave(Parse.User, function(request) {
  ...
  user.setACL(acl);
    user.save({}, { useMasterKey: true }).then(function(s) {
      console.log('[===afterSave succeeded]: '+ '@'+ user.id+'___'+s.get('objectId')+'@' /*+ JSON.stringify(s)*/);
    ...
    acel.setWriteAccess(s.get('objectId'),true);
    acel.setReadAccess(s.get('objectId'),true);
